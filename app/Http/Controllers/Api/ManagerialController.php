...
")
    ...
    private function sumEntry(array &$target, array $source): void
    {
        $target['pagu'] += $source['pagu'];
        $target['realisasi'] += $source['realisasi'];
        $target['realisasi_sampai_tanggal'] += $source['realisasi_sampai_tanggal'];
        $target['outstanding'] += $source['outstanding'];
        $target['blokir'] += $source['blokir'];
    }
